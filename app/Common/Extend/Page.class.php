    ...
    */
    ...
    public function show() {
        ...
        if ($upRow>0){
            ...
            $upPage = "<a class='up' href='".str_replace('__PAGE__',$upRow,$url)."'>".$this->config['prev']."</a>";
        ...
        if ($downRow <= $this->totalPages){
            ...
            $downPage = "<a class='down' href='".str_replace('__PAGE__',$downRow,$url)."'>".$this->config['next']."</a>";
        ...
        if($nowCoolPage == 1){
            ...
            $prePage = "<a class='prev' href='".str_replace('__PAGE__',$preRow,$url)."' >上".$this->rollPage."页</a>";
