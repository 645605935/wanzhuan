...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'<head><meta charset="utf-8" /><base href="'+$config['app']+'"></base><title></title>',
		'<style>',
...
_plugin('core', function(K) {
	...
	_each('link,image,flash,flv,media,anchor'.split(','), function(i, name) {
	...
	self.beforeGetHtml(function(html) {
		...
		.replace(/<img[^>]*class="?ke-(flash|flv|rm|media)"?[^>]*>/ig, function(full) {
