...
KindEditor.plugin('flv', function (K) {
    ...
    var self = this, name = 'flv', lang = self.lang(name + '.'),
              ...
              uploadJson = K.undef(self.uploadJson, '?s=/Vip/Public/uploadJson');
        ...
        edit: function () {
            ...
            var dialog = self.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function (e) {
                        ...
                        var str = self.pluginsPath+'flv/swf/Flvplayer.swf?vcastr_file=';
                        ...
                        var html = K.mediaImg(self.themesPath + 'common/blank.gif', {
                            ...
                            src: self.pluginsPath+'flv/swf/Flvplayer.swf?vcastr_file=' + url,
            ...
            if (allowFlvUpload) {
                ...
                var uploadbutton = K.uploadbutton({
                    ...
                    url: K.addParam(uploadJson,  'dir=flash&path='+$path+''),//'dir=flv'
