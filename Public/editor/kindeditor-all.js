...
KindEditor.plugin('filemanager', function(K) {
	var self = this, name = 'filemanager',
		fileManagerJson = K.undef(self.fileManagerJson, '?s=/Vip/Public/fileManagerJson' ),//self.basePath + 'php/file_manager_json.php'
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, '?s=/Vip/Public/uploadJson' );// self.basePath + 'php/upload_json.php'
	self.plugin.flash = {
		edit : function() {
			var html = [
